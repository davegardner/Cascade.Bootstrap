...
namespace Cascade.Bootstrap.Models {
    public class BootstrapThemeSettingsPart : ContentPart {
        ...
        public bool ShowLogInLinksInMenu
        {
            get { return this.Retrieve(r => r.ShowLogInLinksInMenu, true); }
            set { this.Store(r => r.ShowLogInLinksInMenu, value); }
        }
        public bool ShowLogInLinksInMenuWhenLoggedIn
        {
            get { return this.Retrieve(r => r.ShowLogInLinksInMenuWhenLoggedIn, true); }
            set { this.Store(r => r.ShowLogInLinksInMenuWhenLoggedIn, value); }
        }
    }
}